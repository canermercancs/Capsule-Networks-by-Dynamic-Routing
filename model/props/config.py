...
# 2nd capsule layer (digit capsule) parameters (routing by agreement)
...
decoder_props = {
    'in_units'      : digilayer_props['out_units'], 
    'out_pixels'    : args['image_size'][0]*args['image_size'][1],
    'fc1'           : 512, 
    'fc2'           : 1024,
}
